...
if (isset($_GET['cancel']))
	redirect(link('index'), __('Reg cancel redirect', 'profile'));
	...
	if (empty($errors))
	{
		...
		if (empty($errors))
		{
			...
			if (isset($_POST['language']))
			{
				...
				if (!file_exists(language()->path[$language] . '/common.php')) {
			...
			redirect(link('index'), __('Reg complete', 'profile'));
		}
	}
}
...
assets()->add_js(app()->base_url . '/include/js/min/punbb.timezone.min.js');
