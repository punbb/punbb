...
$forum_rewrite_rules = array(
	...
	'/^feed[\/_-]?(rss|atom)[\/_-]?forum[\/_-]?(topics|posts)[\/_-]?([0-9]+)[\/_-]?(\.xml?|\/)?$/i'							=>	'extern.php?action=feed&content=$2&fid=$3&type=$1',
	'/^feed[\/_-]?(rss|atom)[\/_-]?(f|t)(orum|opic)[\/_-]?([0-9]+)[\/_-]?(\.xml?|\/)?$/i'									=>	'extern.php?action=feed&$2id=$4&type=$1',	'/^(forum|topic)[\/_-]?([0-9]+).*(\.html?|\/)?$/i'																		=>	'view$1.php?id=$2',
