...
<?php
	...
	foreach ($topics as $cur_topic)
	{
		...
		if ($cur_topic['moved_to'] != null)
		{
			...
			$forum_page['item_title']['link'] = '<span class="item-status"><em class="moved">'.sprintf(__('Item status', 'forum'), __('Moved', 'forum')).'</em></span> <a href="'.link('topic', array($cur_topic['moved_to'], sef_friendly($cur_topic['subject']))).'">'.forum_htmlencode($cur_topic['subject']).'</a>';
