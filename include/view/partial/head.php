...
if (FORUM_PAGE == 'redirect') {
	...
	if (strpos(FORUM_PAGE, 'profile') === 0) {
		$head['microid'] = '<meta name="microid" content="mailto+http:sha1:' .
			...
			sha1(forum_link($forum_url['user'], $id))) . '" />';
	}
	...
	if (FORUM_PAGE == 'index') 	{
		$head['rss'] = '<link rel="alternate" type="application/rss+xml" href="' .
			forum_link($forum_url['index_rss']).'" title="RSS" />';
		$head['atom'] = '<link rel="alternate" type="application/atom+xml" href="' .
			forum_link($forum_url['index_atom']).'" title="ATOM" />';
	}
	else if (FORUM_PAGE == 'viewforum') {
		$head['rss'] = '<link rel="alternate" type="application/rss+xml" href="' .
			forum_link($forum_url['forum_rss'], $id) . '" title="RSS" />';
		$head['atom'] = '<link rel="alternate" type="application/atom+xml" href="' .
			forum_link($forum_url['forum_atom'], $id) . '" title="ATOM" />';
	}
	else if (FORUM_PAGE == 'viewtopic') {
		$head['rss'] = '<link rel="alternate" type="application/rss+xml" href="' .
			forum_link($forum_url['topic_rss'], $id) . '" title="RSS" />';
		$head['atom'] = '<link rel="alternate" type="application/atom+xml" href="' .
			forum_link($forum_url['topic_atom'], $id) . '" title="ATOM" />';
	}
	...
	if ($user->g_read_board == '1' && $user->g_search == '1') {
		$head['search'] = '<link rel="search" type="text/html" href="' .
			forum_link($forum_url['search']) . '" title="' . __('Search') . '" />';
		$head['opensearch'] =
	...
	$head['author'] = '<link rel="author" type="text/html" href="' .
		forum_link($forum_url['users']) . '" title="' . __('User list') . '" />';
