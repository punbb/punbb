...
'Profile welcome'			=>	'From this control panel you can apply settings for interacting with the forum and carry out various actions. Any changes made to profile settings will be enabled each time you login. Below is a preview of your profile as other users will see it.',
