...
else if (isset($_GET['show_users']))
{
	...
	if (isset($_POST['delete_users_comply']))
	{
		...
		redirect(link('admin_users'), __('Users deleted', 'admin_users'));
	}
	...
	$crumbs = array(
		...
		array(__('Searches', 'admin_common'), link('admin_users')),
	...
	if (isset($_POST['ban_users_comply']))
	{
		...
		redirect(link('admin_users'), __('Users banned', 'admin_users'));
	}
	...
	if (isset($_POST['change_group_comply']))
	{
		...
		redirect(link('admin_users'), __('User groups updated', 'admin_users'));
	}
